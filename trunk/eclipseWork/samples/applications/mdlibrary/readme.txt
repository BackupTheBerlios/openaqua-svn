    ...
    The project located in this directory has been generated by Matthias Bohlen
    ...
    that a model called 'mdlibrary' has been created within your Magic Draw model.
    
    Important: before launching AndroMDA, be sure to have exported your model.

    /mdlibrary J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Matthias Bohlen\.m2\repository\mdlibrary\

        (*nix)
        /home/Matthias Bohlen/.maven/repository/mdlibrary/
