 ...
 * <ul>
 *   <li>{@link data.impl.EntityImpl#getAttribute <em>Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityImpl extends ElementImpl implements Entity {
	...
	public EList getAttribute() {
		if (attribute == null) {
			attribute = new EObjectContainmentEList(Attribute.class, this, DataPackage.ENTITY__ATTRIBUTE);
		}
		return attribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.ENTITY__ATTRIBUTE:
