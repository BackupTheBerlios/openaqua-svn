 ...
 * <ul>
 *   <li>{@link data.impl.ModelImpl#getEntity <em>Entity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends ElementImpl implements Model {
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.MODEL;
	}
	...
	public EList getEntity() {
		if (entity == null) {
			entity = new EObjectContainmentEList(Entity.class, this, DataPackage.MODEL__ENTITY);
		}
		return entity;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.MODEL__ENTITY:
