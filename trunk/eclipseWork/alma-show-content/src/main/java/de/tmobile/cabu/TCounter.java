 ...
 * 
 */
public class TCounter extends TElement {

	public TCounter(final int id, final int type, final int subtype, final int datatype, final int unittype, final int parentId,
