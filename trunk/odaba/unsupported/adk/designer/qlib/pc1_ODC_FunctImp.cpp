...
\date     $Date: 2006/05/23 13:34:41,67 $
\dbsource adk.dev - ODABA Version 9.0
*/
/******************************************************************************/
#define    OBJ_ID  "pc1_ODC_FunctImp"
...
logical pc1_ODC_FunctImp :: ExistDescription (char *names )
{
...
MethodTypes pc1_ODC_FunctImp :: GetImplementationType (CTX_GUIBase *ctxptr, logical setup_opt )
{
  PropertyHandle  *parent  = GetParentProperty();
...
BEGINSEQ
  ...
  pc1_ODC_PFunction   pfunct_pc(parent);
...
logical pc1_ODC_FunctImp :: InitializeImplementations (PropertyHandle *source_ph )
{
...
logical pc1_ODC_FunctImp :: IsConstructor ( )
{

  pc1_ODC_PFunction   pfunct_pc(GetParentProperty());
...
logical pc1_ODC_FunctImp :: SetupCodeBlocks (CTX_GUIBase *ctxptr )
{
  logical     started = NO;
  logical     term    = NO;
BEGINSEQ
...
#undef     MOD_ID
#define    MOD_ID  "pc1_ODC_FunctImp"

     pc1_ODC_FunctImp :: pc1_ODC_FunctImp (PropertyHandle *prophdl )
