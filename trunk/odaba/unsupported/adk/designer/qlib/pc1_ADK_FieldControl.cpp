...
\date     $Date: 2006/05/23 13:01:41,06 $
\dbsource adk.dev - ODABA Version 9.0
*/
/******************************************************************************/
#define    OBJ_ID  "pc1_ADK_FieldControl"
...
logical pc1_ADK_FieldControl :: Check (int32 start_id, logical recursive )
{
  logical                 term = NO;
BEGINSEQ
...
logical pc1_ADK_FieldControl :: CheckElements (PropertyHandle *prophdl, int32 start_id, logical recursive )
{
...
logical pc1_ADK_FieldControl :: CheckExtent (char *data_source )
{
  PropertyHandle   *fclass = GPH("class");
...
logical pc1_ADK_FieldControl :: CheckPropertyPath (char *data_source )
{
  PropertyHandle   *fclass = GPH("class");
  PropertyHandle   *sdb_struct = fclass->GPH("SDB_Structure");
  char             *type_names;
...
logical pc1_ADK_FieldControl :: InitResourceDB (pc1_ADK_FieldControl &source_control )
{
  logical                 term = NO;
BEGINSEQ
...
logical pc1_ADK_FieldControl :: IsInHierarchy (int32 start_id )
{
...
/******************************************************************************/
/**
\brief  pc1_ADK_FieldControl - Konstruktor
...
#undef     MOD_ID
#define    MOD_ID  "pc1_ADK_FieldControl"

     pc1_ADK_FieldControl :: pc1_ADK_FieldControl (PropertyHandle *prophdl )
