...
#pragma ident	"@(#)filio.h	1.29	00/05/22 SMI"	/* SVr4.0 1.4	*/
 ...
 */
#define	_FIOSNAPSHOTCREATE	_IO('f', 88)	/* create a snapshot */
#define	_FIOSNAPSHOTDELETE	_IO('f', 89)	/* delete a snapshot */
