...
<!--##################################################HTML BODY-->
   ...
   <div id="container">
   	...
   	<div id="intro">
         <!--Logo!!-->
   		<div id="pageHeader">
   		   <h1><span>pageHeader h1 <?php tpl_link(wl(),$conf['title'],'accesskey="h" title="[ALT+H]"')?></span></h1>
   		   <h2><span>pageHeader h2 <?php tpl_link(wl(),$conf['title'],'accesskey="h" title="[ALT+H]"')?></span></h2>
   		</div>
