       ...
       if ($mode == 'xhtml') {
            switch ( $state ) {
              case DOKU_LEXER_ENTER:
                $renderer->doc .= '<script type="text/javascript" src="http://www.blinklist.com/feed2js/feed2js.php?src=http://www.blinklist.com/';
              ...
              case DOKU_LEXER_EXIT:
                $renderer->doc .= '/rss.xml" type="text/javascript"></script>  ';
                //$renderer->doc .= '-->';
                break;
            }
            return true;
